...
class ObjectDumper {
    ...
    static flattenDom(dom, visited, outInstrumentId) {
        let result = this.flatten(dom, visited, outInstrumentId);
...
class ObjectCounter {
    ...
    static countObjects() {
        let visited = new Set();
        let count = this.countObject(window, visited) + this.countDom(window.document.getRootNode(),
                visited);
